    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthFilter jwtFilter, Environment env) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    // ✅ CORRIGIDO: Adiciona /api/tools sem /** para fazer match com POST /api/tools
                    ...
                    // Permite acesso anônimo a /api/analytics/track apenas quando o profile "test" estiver ativo
